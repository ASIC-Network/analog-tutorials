<!--
  ...
  - files live in pages/ and must be named page_N.md, no gaps (page_1.md, page_2.md, ...)
  ...
  - images go in pages/img/ and are referenced relative to pages/, e.g. img/foo.png
  - copy pages/TEMPLATE.md to start a new page
-->
